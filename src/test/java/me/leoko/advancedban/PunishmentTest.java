...
public class PunishmentTest {
    ...
    public void shouldKeepPunishmentAfterRestart(){
        Punishment punishment = new Punishment("leoko", "leoko", "Doing some unit-testing", "JUnit5", PunishmentType.MUTE, TimeManager.getTime(), -1, null, -1);
        punishment.create();
        ...
        Assert.assertEquals("Reason should still match", punishment1.getReason(), "Doing some unit-testing");
    }
