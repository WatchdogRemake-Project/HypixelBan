...
public class BungeeMain extends Plugin {
    ...
    public void onEnable() {
        ...
        if (ProxyServer.getInstance().getPluginManager().getPlugin("RedisBungee") != null) {
            ...
            RedisBungee.getApi().registerPubSubChannels("HypixelBan");
            ProxyServer.getInstance().getConsole().sendMessage("§cHypixelBan §8» §7RedisBungee detected, hooking into it!");
        }
    }
